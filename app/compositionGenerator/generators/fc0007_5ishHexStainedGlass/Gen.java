...
public class Gen extends FCRIG_Basic{
  ...
  public static final Color 
    ...
    BACKGROUNDANDBORDER=Color.white;
  public static final float STROKETHICKNESS=0.01f;
  ...
  protected ColorMapGen getColorMapper(){//TODO ColorMapGen?
    ColorMapGen m=new CM_SymmetricChaos();
    m.setPalette(Palette.P_TOY_STORY_ADJUSTED2);
    return m;}
