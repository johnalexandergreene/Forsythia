 ...
 */
public class Renderer_Rasterizer002_OLD implements Renderer{
  ...
  //interesting or whatever, down palette. rich, earthy
...
//    };
  ...
  //wanderlust glamping
  //really juicy, bright, candy. Beth gives it a big thumbs up.
  private static final Color[] C2=new Color[]{
      new Color(1,24,107),
