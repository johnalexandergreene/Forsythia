...
public class ProjectGrammar implements Serializable{
  ...
  public ProjectGrammar(ForsythiaGrammar0 fg,String name){
    this.name=name;
    init(this,fg);}
   ...
   */
  private static final void init(ProjectGrammar projectgrammar,ForsythiaGrammar0 forsythiagrammar){
  ...
  public ForsythiaGrammar0 getForsythiaGrammar(){
    //create fmetagons.
    ...
    //
    ForsythiaGrammar0 fg=new ForsythiaGrammar0(metagonjigs);
    //DEBUG
//    System.out.println("########################");
