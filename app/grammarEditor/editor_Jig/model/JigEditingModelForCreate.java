 ...
 */
public class JigEditingModelForCreate implements JigEditingModel{
  ...
  public JigEditingModelForCreate(ProjectMetagon targetmetagon){
   ...
   * ################################
   * JIG TAGS
   * A space delimited string of tags
   * ################################
   */
  
  private String jigtags="";
  ...
  /*
   * ################################
   * SECTION METHODS THAT IMPLEMENT PART OF JigEditingModel INTERFACE
   * ################################
   */
  ...
  public List<KPolygon> getSectionPolygons(){
    List<KPolygon> p=new ArrayList<KPolygon>(sections.size());
    for(JigSectionEditingModel s:sections)
      p.add(s.getPolygon());
    return p;}
  
  public void incrementSectionChorus(int sectionindex){
    sections.get(sectionindex).incrementChorus();}
  
  public int getSectionChorus(int sectionindex){
    return sections.get(sectionindex).chorusindex;}
  
  public void incrementSectionAnchor(int sectionindex){
    sections.get(sectionindex).incrementAnchor();}
  
  public int getSectionAnchorIndex(int sectionindex){
    return sections.get(sectionindex).anchorindex;}
  
  public void setSectionTags(int sectionindex,String tags){
    sections.get(sectionindex).tags=tags;}
  
  public String getSectionTags(int sectionindex){
    return sections.get(sectionindex).tags;}
