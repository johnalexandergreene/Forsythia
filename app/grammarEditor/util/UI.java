...
public class UI{
   ...
   * EDITORS
   *   CREATE JIG
   *   VIEW PROTOJIG EDIT TAGS
   * ################################
   */
  
  public static final Color
    EDITORCREATEPROTOJIG_HOSTMETAGONFILLCOLOR=new Color(0,255,0,64),
    EDITORCREATEPROTOJIG_FOCUSSECTIONFILLCOLOR=new Color(255,255,0,64),
    EDITORCREATEPROTOJIG_CONNECTEDHEADVERTEXDECORATIONCOLOR=new Color(255,176,63),
    EDITORCREATEPROTOJIG_UNCONNECTEDHEADVERTEXDECORATIONCOLOR=new Color(255,255,255);
  
  public static final int
    EDITORCREATEPROTOJIG_HEADVERTEXDECORATIONSPAN=32;
  
  public static final float 
    EDITORCREATEPROTOJIG_HEADVERTEXDECORATIONSTROKETHICKNESS=7.0f;
  
  public static final Stroke 
    EDITORCREATEPROTOJIG_HEADVERTEXDECORATIONSTROKE=
      new BasicStroke(EDITORCREATEPROTOJIG_HEADVERTEXDECORATIONSTROKETHICKNESS,
        BasicStroke.CAP_SQUARE,BasicStroke.JOIN_ROUND,0,null,0);
