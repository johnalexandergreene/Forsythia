...
public class EVMETUI extends JPanel{

  public EVMETGrid grid;
  ...
  public EVMETUI(){
    ...
    btnsavemetagon.addMouseListener(new MouseAdapter(){
      public void mouseClicked(MouseEvent e){
        GE.editor_editmetagondetails.saveModificationsAndReturnToGrammarEditor();}});
    
    btndiscardmetagon = new JButton("Discard");
    ...
    btndiscardmetagon.addMouseListener(new MouseAdapter(){
      public void mouseClicked(MouseEvent e){
        GE.editor_editmetagondetails.discardModificationsAndReturnToGrammarEditor();}});
