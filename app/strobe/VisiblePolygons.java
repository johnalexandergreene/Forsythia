...
//      if(polygon.getDPolygon().roughlyIntersect(viewport)){
   ...
   */
  private List<FPolygon> getPolygonChildren(FPolygon polygon,ForsythiaGrammar_Basic grammar){
  ...
  private void cultivateOnce(FPolygon polygon,ForsythiaGrammar_Basic grammar){
    Jig jig=selectJig(polygon,grammar);
    jig.createNodes(polygon);}
  
  private Jig selectJig(FPolygon polygon,ForsythiaGrammar_Basic grammar){
