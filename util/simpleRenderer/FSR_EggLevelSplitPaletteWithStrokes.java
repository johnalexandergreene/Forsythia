...
public class FSR_EggLevelSplitPaletteWithStrokes extends ForsythiaSimpleRenderer_Abstract{
  ...
  public FSR_EggLevelSplitPaletteWithStrokes(Color backgroundcolor,int margin,Color[] color0,Color[] color1,Color strokecolor,float strokewidth){
  ...
  public FSR_EggLevelSplitPaletteWithStrokes(Color[] color0,Color[] color1,Color strokecolor,float strokewidth){
    super();
    this.color0=color0;
    this.color1=color1;
    this.strokecolor=strokecolor;
