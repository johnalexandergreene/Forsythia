...
public class FSC_Basic extends ForsythiaSimpleComposer_Abstract{
  ...
  public FSC_Basic(double detailsizefloor,double symmetry){
  ...
  public static final double DETAILSIZEFLOOR_DEFAULT=0.05;
  ...
  public static final void main(String[] a){
    ForsythiaSimpleComposer_Abstract c=new FSC_Basic();
    c.serialize();
  }
